...
test('release is v0.10.0',()=>assert.ok(['0.10.0','0.11.0','0.11.1'].includes(pkg.version)));
test('release marker is Store Designer v3',()=>assert.match(config,/(?:0\.10\.0-store-designer-v3|0\.11\.0-operations-control-completion|0\.11\.1-customer-experience-reliability)/));
