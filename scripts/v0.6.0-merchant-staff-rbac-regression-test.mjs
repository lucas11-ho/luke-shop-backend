...
test('package version carries v0.6.0 RBAC forward',()=>assert.ok(['0.6.0','0.7.0','0.7.1','0.8.0','0.9.0','0.10.0'].includes(pkg.version)));
...
})) test(`${file} remains immutable`,()=>assert.equal(sha(file),hash));
