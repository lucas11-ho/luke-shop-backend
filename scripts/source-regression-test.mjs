...
test('release remains compatible through v0.15.0', () => assert.ok(['0.9.0','0.10.0','0.11.0','0.11.1','0.12.0','0.13.0','0.14.0','0.14.1','0.14.2','0.15.0'].includes(pkg.version)));
...
console.log(`${passed}/${tests.length} Luke Shop Backend v0.15.0 source regression checks passed`);
