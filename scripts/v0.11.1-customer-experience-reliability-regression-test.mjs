...
test('release is v0.11.1',()=>assert.ok(['0.11.1','0.12.0','0.13.0','0.14.0'].includes(pkg.version)));
test('runtime release marker identifies Customer Experience reliability repair',()=>assert.match(config,/(?:0\.11\.1-customer-experience-reliability|0\.12\.0-delivery-location-status-visuals|0\.13\.0-identity-fulfillment-notifications)/));
