...
assert.match(routes,/PUT\('\/v1\/merchant\/products\/:productId\/nature'/,'Merchant product nature conversion endpoint must exist');
...
assert.match(routes,/POST\('\/v1\/customer\/cart\/repair'/,'Authenticated customer cart repair endpoint must exist');
